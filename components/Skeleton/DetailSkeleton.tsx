...
export default async function DetailSkeleton() {
  const t = await getTranslations("DetailSkeleton");
  return (
    <section className="flex flex-col gap-6 pb-2">
      ...
      <section className="mb-8">
        ...
        <h3 className="font-semibold text-lg mt-4 mb-2">{t("aboutHotel")}</h3>
        <Skeleton className="h-6 w-full mb-2 rounded-md bg-gray-300 animate-pulse" />
      ...
      <section>
        <h2 className="text-xl font-semibold my-4">{t("roomsAvailable")}</h2>
