...
const NavigationItem = ({
  ...
  return (
    <div
      className={`h-10 w-10 rounded-full bg-background flex items-center justify-start relative overflow-hidden cursor-pointer transition-all duration-[2000ms] ease-in-out ${isOpen ? "w-max pr-3" : ""}`}
    >
      <Link
        href={href}
